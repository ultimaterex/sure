...
module WiseItem::Unlinking
  # Concern that encapsulates unlinking logic for a Wise item.
  extend ActiveSupport::Concern

  # Idempotently remove all connections between this Wise item and local accounts.
  # - Detaches any AccountProvider links for each WiseAccount
